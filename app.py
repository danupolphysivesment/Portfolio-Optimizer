...
def section_methods(cfg: dict):
    ...
    st.markdown(
        '<span class="pl-sub">Every method takes the same historical data and turns it '
        "into a set of weights — they just disagree on <em>how</em>. Start with the "
        "cheat-sheet, then open any method for the full story.</span>",
        unsafe_allow_html=True,
    )
